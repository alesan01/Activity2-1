...
public class ManufacturedEngine implements Engine {
   ...
   *
   * @param engineManufacturer manufacturer
   * @param engineManufacturedDate date of manufacture
   * @param engineMake engine make
   * @param engineModel model of engine
   * @param engineType engine type
   * @param engineCylinders engine cyclinders
   * @param driveTrain drive train of engine
   */
  ...
  /**
   * toString function returns engine manufacture information as a string.
   */
